                        ...
                        <div class="col-lg-3">
                            <div class="main-left-sidebar">
                                ...
                                <div class="suggestions full-width">
                                    <div class="sd-title">
                                        <h3>Usuarios en este proyecto</h3>
                                    ...
                                    <div class="tab-feed st2">
                                        <ul>
                                            ...
                                            <li data-tab="saved-jobs">
                                                <a href="#" title="">
                                                    <img src="../../../../public/images/ic4.png" alt="">
                                                    <span>Saved Jobs</span>
                                                </a>
                                            </li>
                                            <li data-tab="my-bids">
                                                <a href="#" title="">
                                                    <img src="../../../../public/images/ic5.png" alt="">
                                                    <span>My Bids</span>
                                                </a>
                                            </li>
                                ...
                                <div class="product-feed-tab current" id="feed-dd">
                                    <div class="posts-section">
                                        ...
                                        <div class="post-bar">
                                            ...
                                            <div class="epi-sec">
                                                <ul class="descp">
                                                    <li><img src="../../../../public/images/icon8.png" alt=""><span>Front End Developer</span></li>
                                                    <li><img src="../../../../public/images/icon9.png" alt=""><span>India</span></li>
                                                </ul>
                                                <ul class="bk-links">
                                                    <li><a href="#" title=""><i class="la la-bookmark"></i></a></li>
    ...
    <footer>
        <div class="footy-sec mn no-margin">
            <div class="container">
                ...
                <p><img src="../../../../public/images/copy-icon2.png" alt="">Copyright 2018</p>
                <img class="fl-rgt" src="../../../../public/images/logo2.png" alt="">
            </div>
        </div>
    </footer><!--footer end-->
