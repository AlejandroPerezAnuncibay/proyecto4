...
<button type="button" id="sacarEstadisticas" onclick="mostrarDatos()" class="btn btnEnviar btn-primary" style="margin-top: 10px;">Mostrar estadisticas</button>
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link " id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Proyectos</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-content" id="tab-content" style="display: none;">
                    <div class="tab-pane " id="home" role="tabpanel" aria-labelledby="home-tab"><div id="chart"></div></div>
